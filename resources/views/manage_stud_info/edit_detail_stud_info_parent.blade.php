<x-app-layout>
    <x-slot name="header">
        <h2 class="font-bold text-3xl text-center text-white leading-tight  bg-indigo-900 border-indigo-300 uppercase">
            <a href="{{ route('studInfo.detailStudent', $detailStudent->id)}}">{{ __('STUDENT INFORMATION') }}</a>
        </h2>
    </x-slot>
    ...
    @foreach ($detailStudent as $student)
        @php
            $id = $student->id;
        @endphp
        <form method="POST" action="{{ '/studInfo/updateStudInfo' }}/{{ $id != null ? $id : 0 }}"
                    ...
                    <div class="p-6 bg-white border-b border-gray-200">
                        <section class="justify-center">
                                ...
                                <div class="flex flex-wrap px-6">
                                    <div class="w-full md:px-4 lg:px-6 py-5">
                                        <div class="grid grid-cols-1 mt-5 mx-7">
                                            <h1 class="md:text-sm text-xs text-red-500 text-light font-semibold mb-2">*Only can edit detail address and salary</h1>
                                            <label
                                                        ...
                                                        <label
                                                            ...
                                                            <div class='flex flex-col items-center justify-center'>
                                                                <img class="w-40 h-40 border-4 border-dashed"
                                                                    id="output"
                                                                    src="{{ asset($student->studImage) }}" />
                                                                <input type='file' name="studImage" id="image"
                                                                    onchange="loadFile(event)" class="hidden" disabled/>
                                                            </div>
                                                        </label>
                                                @endif
                                            </div>
                                    ...
                                    <div class="grid grid-cols-1 mt-5 mx-7">
                                        <label
                                            ...
                                            Full Name</label>
                                        <input name="studFullName"
                                            class="py-2 px-3 rounded-lg border-2 border-purple-300 mt-1 focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent"
                                            type="text" value="{{ $student->studFullName }}" disabled />
                                    </div>
                                    ...
                                    <div class="grid grid-cols-1 mt-5 mx-7">
                                        <label
                                            ...
                                            Identity Card</label>
                                        <input name="studIdCard"
                                            class="py-2 px-3 rounded-lg border-2 border-purple-300 mt-1 focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent"
                                            type="text" value="{{ $student->studIdCard }}" disabled />
                                    </div>
                                    ...
                                    <div class="grid grid-cols-1 mt-5 mx-7">
                                        ...
                                        <input name="address"
                                            class="py-2 px-3 rounded-lg border-2 border-purple-300 mt-1 focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent"
                                            type="text" value="{{ $student->address }}" />
                                    </div>
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-8 mt-5 mx-7">
                                        ...
                                        <div class="grid grid-cols-1">
                                            ...
                                            <input name="age"
                                                class="py-2 px-3 rounded-lg border-2 border-purple-300 mt-1 focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent"
                                                type="text" value="{{ $student->age }}" disabled />
                                        </div>

                                        <div class="grid grid-cols-1">
                                            <label
                                                class="uppercase md:text-sm text-xs text-gray-500 text-light font-semibold">B.O.D
                                                (Example: 11 January 2000)</label>
                                            <input name="brthOfDate"
                                                class="py-2 px-3 rounded-lg border-2 border-purple-300 mt-1 focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent"
                                                type="text" value="{{ $student->brthOfDate }}" disabled />
                                        </div>
                                        ...
                                        <div class="grid grid-cols-1">
                                            ...
                                            <select name="religon"
                                                class="py-2 px-3 rounded-lg border-2 border-purple-300 mt-1 focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent" disabled>
                                    ...
                                    <div class="grid grid-cols-1 mt-5 mx-7">
                                        <label
                                            ...
                                            Full Name</label>
                                        <input name="parentFullName"
                                            class="py-2 px-3 rounded-lg border-2 border-purple-300 mt-1 focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent"
                                            type="text" value="{{ $student->parentFullName }}" disabled />
                                    </div>

                                    <div class="grid grid-cols-1 mt-5 mx-7">
                                        <label
                                            class="uppercase md:text-sm text-xs text-gray-500 text-light font-semibold">Parent
                                            Identity Card (With -)</label>
                                        <input name="parentIdCard"
                                            class="py-2 px-3 rounded-lg border-2 border-purple-300 mt-1 focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent"
                                            type="text" value="{{ $student->parentIdCard }}" disabled />
                                    </div>
                                    ...
                                    <div class="grid grid-cols-1 mt-5 mx-7">
                                        <label
                                            ...
                                            Salary (RM) </label>
                                        <input name="parentSalary"
                                            class="py-2 px-3 rounded-lg border-2 border-purple-300 mt-1 focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent"
                                            type="text" value="{{ $student->parentSalary }}" />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class='flex items-center justify-center pt-10 pb-8 '>
                                <button type="submit"
                                    class=' md:w-5/12 w-2/4 bg-indigo-900 border-indigo-300 rounded-full  shadow-xl font-medium text-white px-4 py-2'>UPDATE</button>
                            </div>
                            <section>
                    </div>
                </div>
