                                ...
                                <form method="post" action="{{ route('manage_profile.update_profile') }}">
                                    ...
                                    <div class="grid grid-cols-1 mt-5 mx-7">
                                        ...
                                        <input
                                            ...
                                            type="text" name="first_name" value="{{ $parentData->first_name }}" />
                                    </div>
                                    ...
                                    <div class="grid grid-cols-1 mt-5 mx-7">
                                        ...
                                        <input
                                            class="py-2 px-3 rounded-lg border-2 border-purple-300 mt-1 focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent"
                                            type="text" name="last_name" value="{{ $parentData->last_name }}" />
                                    </div>
                                    ...
                                    <div class="grid grid-cols-1 mt-5 mx-7">
                                        ...
                                        <input
                                            class="py-2 px-3 rounded-lg border-2 border-purple-300 mt-1 focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent"
                                            type="text" name="phone_number" value="{{ $parentData->phone_number }}" />
                                    </div>
                                    ...
                                    <div class="grid grid-cols-1 mt-5 mx-7">
                                        ...
                                        <input
                                            class="py-2 px-3 rounded-lg border-2 border-purple-300 mt-1 focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent"
                                            type="text" name="email" value="{{ $parentData->email }}" />
                                    </div>
                                    ...
                                    <div class="grid grid-cols-1 mt-5 mx-7">
                                        ...
                                        <input
                                            class="py-2 px-3 rounded-lg border-2 border-purple-300 mt-1 focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent"
                                            type="text" name="username" value="{{ $parentData->username }}" />
                                    </div>
