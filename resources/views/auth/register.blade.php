    ...
    <x-auth-card>
        ...
        <form method="POST" action="{{ route('register.parent') }}">
            ...
            <div class="mt-4">
                ...
                {!! Form::select('student',$studentList,$student,[ 'class'=>'block mt-1 w-full border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm','required','placeholder'=>__('Please select'),'id'=>'student','name'=>'student']) !!}
            </div>
