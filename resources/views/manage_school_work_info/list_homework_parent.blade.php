<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-3xl text-center text-white leading-tight  bg-indigo-900 border-indigo-300 uppercase ">
            <a href="/schoolWorkInfo">{{ __('SCHOOL WORK INFORMATION') }}</a>
        </h2>
    </x-slot>
    <div class="">
                                    ...
                                    @if ($schoolWorkDate == $date)
                                        <div
                                            ...
                                            <div class="flex flex-col p-5 ">
                                                <p class=" font-semibold text-black dark:text-gray-300 text-3xl pb-3">
                                            ...
                                            <div class="flex flex-col justify-end pr-3 pb-6">
                                                <p class="text-white font-semibold  ">Due by : {{ $convertDueDate }}
                                                </p>
                                            </div>
                                        </div>
                                    @else
                                        <div
                                            ...
                                            <div class="flex flex-col justify-end pr-3 pb-6">
                                                <p class="text-red-400 font-semibold  ">Due by : {{ $convertDueDate }}
                                                </p>
                                            </div>
                                        </div>
                                    @endif
