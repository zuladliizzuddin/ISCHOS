                    ...
                    <div class="container mx-auto">
                        <div class="flex flex-wrap px-6">
                            <div class="w-full md:px-4 lg:px-6 py-5">
                                ...
                                @foreach ($viewSocialMediaGroup as $item)
                                    @php
                                        $id = $item->id;
                                    @endphp

                                    <form method="POST"
                                        action="{{ route('socialMediaGroup.updateSocialMediaGroup') }}/{{ $id != null ? $id : 0 }}"
                                        ...
                                        <div class="grid grid-cols-1 mt-5 mx-7">
                                            <select name="platform"
                                                ...
                                                <option value="whatsapp"
                                                    {{ old('platform', $item->platform) == 'whatsapp' ? 'selected' : '' }}>
                                                    Whatsapp</option>
                                                <option value="telegram"
                                                    {{ old('platform', $item->platform) == 'telegram' ? 'selected' : '' }}>
                                                    Telegram</option>
                                            </select>
                                        ...
                                        <div class="grid grid-cols-1 mt-5 mx-7">
                                            ...
                                            <input name="link"
                                                class="py-2 px-3 rounded-lg border-2 border-purple-300 mt-1 focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent"
                                                type="text" value="{{ $item->link }}" placeholder="Insert Link" />
                                        </div>
                                        ...
                                        <div class="grid grid-cols-1 mt-5 mx-7">
                                            ...
                                            <textarea name="name"
                                                ...
                                                type="text"
                                                placeholder="Insert Name of Media Social">{{ $item->name }}</textarea>
                                        </div>
