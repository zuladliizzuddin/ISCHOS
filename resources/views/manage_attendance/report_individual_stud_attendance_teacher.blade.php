<x-app-layout>
    ...
    <div class="py-12">
        <form action="{{ '/studAttendance/individualAttendanceReport' }}/{{ $student->student_id != null ? $student->student_id : 0 }}">
            @csrf
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                ...
                <div
                    ...
                    <p class="text-gray-900 dark:text-gray-300 font-bold">{{ $student->student->studFullName  }}</p>
                </div>
                <br>
                <div
