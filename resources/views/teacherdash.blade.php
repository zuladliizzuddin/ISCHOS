                            ...
                            <div class="carousel-inner ">
                                <div class="carousel-item active ">
                                    <div
                                        ...
                                        <!-- SMALL CARD ROUNDED -->
                                        <a class="hover:no-underline"
                                            href="{{ route('studAttendance.scanAttendance') }}">
                                            <div
                                                class="grid bg-white  dark:bg-gray-800 bg-opacity-95 border-opacity-60  h-40 | p-4 border-solid  rounded-md border-2 shadow-md | flex justify-around cursor-pointer | hover:bg-grey dark:hover:bg-indigo-600 hover:border-transparent | transition-colors duration-500">
                                ...
                                <div class="carousel-item">
                                    <div
                                        ...
                                        <!-- SMALL CARD ROUNDED -->
                                        <a class="hover:no-underline" href="{{ route('classInfo.list_classInfo') }}">
                                            <div
                                                class="grid bg-white  dark:bg-gray-800 bg-opacity-95 border-opacity-60  h-40 | p-4 border-solid  rounded-md border-2 shadow-md | flex justify-around cursor-pointer | hover:bg-grey dark:hover:bg-indigo-600 hover:border-transparent | transition-colors duration-500">

                                                <div class="flex justify-center items-center">
                                                    <img class="w-16 h-16"
                                                        src="{{ asset('img/class_icon.png') }}" alt="" />
                                                </div>
                                ...
                                <div class="carousel-item">
                                    <div
                                        ...
                                        <!-- SMALL CARD ROUNDED -->
                                        <a class="hover:no-underline" href="{{ route('studInfo.list_studInfo') }}">
                                            <div
                                                class="grid bg-white  dark:bg-gray-800 bg-opacity-95 border-opacity-60  h-40 | p-4 border-solid  rounded-md border-2 shadow-md | flex justify-around cursor-pointer | hover:bg-grey dark:hover:bg-indigo-600 hover:border-transparent | transition-colors duration-500">
                        ...
                        <div class=" mt-16 p-2 ">
                            <div class="container pb-12 ">
                                <div class="float-left">
                                    <h2 class="text-xl text-grey-light ">Student Class</h2>
                                </div>
                                <div class="float-right text-blue-500 pt-0.5 ">
                                    <a class="hover:no-underline" href="{{ route('classInfo.list_classInfo') }}">See
                                        all</a>
                                </div>
                            </div>
                            <div id="carouselControls" class="carousel slide md:w-3/4 md:m-auto " data-interval="false">
                                ...
                                <div class="carousel-inner ">
                                    {{-- First Slider --}}
                                    @foreach ($studentSlider->chunk(2) as $studCollection)
                                        <div class="carousel-item  {{ $loop->first ? 'active' : '' }}">
                                            <div id="container" class="w-4/5 mx-auto">
                                                <div
                                                    ...
                                                    @foreach ($studCollection as $stud)
                                                        @php
                                                            $id = $stud->id;
                                                        @endphp
                                                        <div class="grid md:w-48 md:h-full w-28 h-full pb-5">
                                                            <div class=" bg-white px-6 py-8 rounded-lg shadow-md text-center hover:shadow-2xl transform duration-200"
                                                                onclick="window.location.href='{{ '/classInfo/detailClassStudent' }}/{{ $id != null ? $id : 0 }}'">
                                                                <div class="mb-3">
                                                                    @if ($stud->studImage != null)
                                                                        <img class="md:w-28 md:h-28 w-16 h-16 mx-auto rounded-full"
                                                                            src={{ url($stud->studImage) }} alt="" />
                                                                    @else
                                                                        <img class="md:w-28 md:h-28 w-16 h-16 mx-auto rounded-full"
