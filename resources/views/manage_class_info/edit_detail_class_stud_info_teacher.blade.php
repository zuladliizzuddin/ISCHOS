<x-app-layout>
    ...
    @foreach ($detailStudent as $student)
        @php
            $id = $student->id;
        @endphp
        <form method="POST" action="{{ '/classInfo/updateClassStudInfo' }}/{{ $id != null ? $id : 0 }}"
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 bg-white border-b border-gray-200">
                                    ...
                                    <div class="w-full md:px-4 lg:px-6 py-5">
                                        ...
                                        <div class="grid grid-cols-1 mt-5 mx-7">
                                            ...
                                            <input name="studFullName"
                                                ...
                                                type="text" value="{{ $student->studFullName }}" />
                                        </div>
                                        ...
                                        <div class="grid grid-cols-1 mt-5 mx-7">
                                            ...
                                            <input name="studIdCard"
                                                class="py-2 px-3 rounded-lg border-2 border-purple-300 mt-1 focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent"
                                                type="text" value="{{ $student->studIdCard }}" />
                                        </div>
                                        ...
                                        <div class="grid grid-cols-1 mt-5 mx-7">
                                            <label
                                                ...
                                                Name</label>
                                            {!! Form::select('class', $clasList, $class, ['class' => 'py-2 px-3 rounded-lg border-2 border-purple-300 mt-1 focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent', 'required', 'id' => 'class', 'name' => 'class']) !!}
                                        </div>
                                        ...
                                        <div class="grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-8 mt-5 mx-7">
                                            ...
                                            <div class="grid grid-cols-1">
                                                ...
                                                <input name="brthOfDate"
                                                    class="py-2 px-3 rounded-lg border-2 border-purple-300 mt-1 focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent"
                                                    type="text" value="{{ $student->brthOfDate }}" />
                                            </div>
                                        ...
                                        <div class="grid grid-cols-1 mt-5 mx-7">
                                            ...
                                            <input name="parentFullName"
                                                class="py-2 px-3 rounded-lg border-2 border-purple-300 mt-1 focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent"
                                                type="text" value="{{ $student->parentFullName }}" />
                                        </div>
                                        ...
                                        <div class="grid grid-cols-1 mt-5 mx-7">
                                            ...
                                            <input name="parentIdCard"
                                                class="py-2 px-3 rounded-lg border-2 border-purple-300 mt-1 focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent"
                                                type="text" value="{{ $student->parentIdCard }}" />
                                        </div>
                        ...
                        <div class='flex items-center justify-center pt-10 pb-8 '>
                            <button type="submit"
                                class=' md:w-5/12 w-11/12 bg-indigo-900 border-indigo-300 rounded-full shadow-xl font-medium text-white px-4 py-2'>UPDATE</button>
                        </div>
                    </div>
                </div>
            </div>
